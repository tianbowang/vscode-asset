...
const allFlows = [
    new class UrlHandlerFlow {
        ...
        async trigger({ scopes, baseUri, redirectUri, logger, nonce, callbackUri, uriHandler, enterpriseUri }) {
    ...
    new class LocalServerFlow {
        ...
        async trigger({ scopes, baseUri, redirectUri, logger, enterpriseUri }) {
